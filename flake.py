...
class Branch:
    ...
    def place_nodes(self):
        ...
        # print('origin {}, vec {}, len {}, density {}, prob {}.'.format(self.ori, self.vec, self.leng, self.dens,
        # self.prob))
        nodes = []
    ...
    def get_angles(self, n):
        ...
        my_angle = polar(self.vec)
        pairs = (n - 1) // 2
        angles = []
        theta = 360 / n
        for i in range(pairs):
            pair = [my_angle + theta * (i + 1), my_angle - theta * (i + 1)]
